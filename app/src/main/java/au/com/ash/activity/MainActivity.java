...
import au.com.ash.common.BaseActivity;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.getHeaderView(0).setOnClickListener(this::onNavHeaderClicked);
    ...
    private void onNavHeaderClicked(View view) {
